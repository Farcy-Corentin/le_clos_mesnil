 ...
 */
final class Version20210203155541 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, cat_name VARCHAR(50) NOT NULL, INDEX IDX_64C19C112469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE country (id VARCHAR(2) NOT NULL, cou_name VARCHAR(45) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE gite (id INT AUTO_INCREMENT NOT NULL, git_name VARCHAR(25) NOT NULL, git_description LONGTEXT NOT NULL, git_address VARCHAR(100) NOT NULL, git_city VARCHAR(50) NOT NULL, git_phone VARCHAR(10) NOT NULL, git_mail VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE post (id BIGINT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, post_date DATETIME NOT NULL, post_content LONGTEXT NOT NULL, post_title LONGTEXT NOT NULL, post_status VARCHAR(20) NOT NULL, post_comment_status VARCHAR(20) NOT NULL, post_name VARCHAR(200) NOT NULL, post_comment_count BIGINT NOT NULL, post_update_date DATETIME DEFAULT NULL, INDEX IDX_5A8A6C8D12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reservation (id BIGINT AUTO_INCREMENT NOT NULL, users_id BIGINT NOT NULL, season_id INT NOT NULL, res_date DATETIME NOT NULL, res_date_start DATETIME NOT NULL, res_date_end DATETIME NOT NULL, res_price INT NOT NULL, res_payment_date DATETIME DEFAULT NULL, INDEX IDX_42C8495567B3B43D (users_id), INDEX IDX_42C849554EC001D1 (season_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE room (id INT AUTO_INCREMENT NOT NULL, gite_id INT NOT NULL, roo_name VARCHAR(50) NOT NULL, rou_picture VARCHAR(100) DEFAULT NULL, INDEX IDX_729F519B652CAE9B (gite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
